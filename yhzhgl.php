		...
		if($rowscount>0)
			{
					...
					echo "<script language='javascript'>alert('该用户名已经存在,请换电话用户名！');history.back();</script>";
			}
			else
			{
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#6699CC" style="border-collapse:collapse">    <tr>
      <td>用户名：</td>
    ...
    <tr>
      <td>权限:</td>
      <td><input name="cx" type="radio" value="辅导员" checked="checked" />
      辅导员
        <input type="radio" name="cx" value="超级管理员" />
      超级管理员 <input type="radio" name="cx" value="教务处" />教务处</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
