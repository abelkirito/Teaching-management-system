...
{   $url = $_SESSION['add'];
	...
	$sql="update xinwentongzhi set biaoti='$biaoti',leibie='$leibie',neirong='$neirong',dianjilv='$dianjilv',tianjiaren='$tianjiaren' where shouyetupian='$url'";
	$conn = new ConnectDb();
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="white" style="border-collapse:collapse">    
	<tr><td>标题：</td><td><input name='biaoti' type='text' id='biaoti' value='' size='50'  />&nbsp;*</td></tr><tr><td>类别：</td><td><input name='leibie' type='text' id='leibie' value='<?php echo $lb;?>' />&nbsp;*</td></tr><tr><td>内容：</td>
	...
	</tr><tr><td>点击率：</td><td><input name='dianjilv' type='text' id='dianjilv' value='1' /></td></tr><tr><td>添加人：</td><td><input name='tianjiaren' type='text' id='tianjiaren' value='<?php echo $_SESSION["username"]; ?>' />&nbsp;*</td></tr>
...
<script>
        ...
        var uploader = WebUploader.create({
            ...
            // 文件接收服务端。
            server: 'http://localhost:80/system/upload4.php',
